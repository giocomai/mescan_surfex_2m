...
The data have been generated using Copernicus Climate Change Service information (2019): [UERRA regional reanalysis for Europe on single levels from 1961 to 2019](https://cds.climate.copernicus.eu/cdsapp#!/dataset/reanalysis-uerra-europe-single-levels?tab=overview) 

# Context, data quality, and warnings



https://www.youtube.com/watch?v=cAzMzIepOC8

this video outlines some common issues related to data grids, but does not go into the specifics that are peculiar of the dataset used as an example.

For more information, check out the methodological note at the bottom of this article and read the documentation that accompanies the original dataset. 

Some of the issues outlined in the video are mentioned also in the original documentation: “results in complex terrain, such as mountainous regions or coastal areas, are generally less reliable than results over a more homogeneous terrain. The models cannot represent the strong gradients that sometimes are caused by the variable terrain.”
